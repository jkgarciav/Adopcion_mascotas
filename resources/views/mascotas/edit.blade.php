        ...
        <div class="row">
            <div class="col-xl-9 mx-auto">
                <div class="cta-inner  rounded">
                    ...
                    <form action="{{ route('mascotas.update',$mascota->id) }}" method="POST" enctype="multipart/form-data" class="container col-sm-10">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Nombre mascota</label>
                            <input type="text" value="{{$mascota->nombre}}" class="form-control" name="nombre" id="exampleFormControlInput1" placeholder="Nombre de la mascota">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Color</label>
                            <input type="text" value="{{$mascota->color}}" class="form-control" name="color"id="exampleFormControlInput1" placeholder="Color predominante en la mascota">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control"  name="edad" id="exampleFormControlSelect1">
                                ...
                                @foreach($edades as $edad)
                                    <option value="{{$edad->id}}" {{ $edad->id == $mascota->edad_id ? 'selected' : ''}}>{{$edad->descripcion}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="especie" id="exampleFormControlSelect1">
                                ...
                                @foreach($especies as $especie)
                                    <option value="{{$especie->id}}" {{ $especie->id == $mascota->especie_id ? 'selected' : ''}}>{{$especie->descripcion}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="tamaño" id="exampleFormControlSelect1">
                                ...
                                @foreach($tamaños as $tamaño)
                                    <option value="{{$tamaño->id}}" {{ $tamaño->id == $mascota->tamaño_id ? 'selected' : ''}}>{{$tamaño->descripcion}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="sexo" id="exampleFormControlSelect1">
                                ...
                                @foreach($sexos as $sexo)
                                    <option value="{{$sexo->id}}" {{ $sexo->id == $mascota->sexo_id ? 'selected' : ''}}>{{$sexo->descripcion}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-dark">Guardar Editado De Mascota</button>
                    </form>
                </div>
            </div>
        </div>
