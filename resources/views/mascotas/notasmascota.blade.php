            ...
            <div class="col-xl-9 mx-auto">
                <div class="cta-inner  rounded">
                    <h2 class="section-heading mb-5">
                        <span class="section-heading-upper">Diligenciar en este campo la valoracion realizada a la mascota </span>
                    </h2>
                    <form action="{{route('mascotas.notas.update', $mascota_id)}}" enctype="multipart/form-data"  method="POST" class="container col-sm-10">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Nota mascota</label>
